...
const Skills = () => {
    ...
    const skillsData = [
        { id: 1, name: "C", category: "language", icon: "◆" },
        { id: 2, name: "JavaScript", category: "language", icon: "◆" },
        { id: 3, name: "Java", category: "language", icon: "◆" },
        { id: 4, name: "HTML", category: "language",  icon: "◆" },
        { id: 5, name: "CSS", category: "language",  icon: "◆" },
        { id: 6, name: "React", category: "framework", icon: "●" },
        { id: 7, name: "Node.js", category: "framework", icon: "●" },
        { id: 8, name: "Express", category: "framework", icon: "●" },
        { id: 9, name: "MongoDB", category: "database", icon: "▲" },
        { id: 10, name: "MySQL", category: "database", icon: "▲" },
        { id: 11, name: "GitHub", category: "tool", icon: "◇" },
        { id: 12, name: "RESTful APIs", category: "tool", icon: "◇" },
        { id: 13, name: "JWT", category: "security", icon: "★" },
