...
//     features:
//       "AI-based system for detecting driver fatigue using real-time monitoring.",
//     images: [],
...
//   },
//   {
//     name: "Backend API + Documentation Task for FMC",
//     description: "This was a task for a job interiew. Made a backend RESTFUL API with JWT Based Authentication ",
//     features:A RESTful API built with Node.js, Express, and MongoDB (Mongoose) for managing users and ships.
...
//       "",
//     images: [],
//     skills: ["Javascript","MongoDB","Express", "Nodejs","Postman", "API Documentation"],
